...
<body>
  ...
  <div class="container">
    <header class="header">
      <div>
        <h1>Changelog</h1>
        <p class="subtitle">Memlink · <a href="https://github.com/aiustantt/memlink/issues">Report a bug</a></p>
      </div>
      <div class="social">
        <a href="https://x.com/aiustantt" target="_blank" rel="noopener" aria-label="X (formerly Twitter)">${ICON_X}</a>
        <a href="https://github.com/aiustantt/memlink" target="_blank" rel="noopener" aria-label="GitHub">${ICON_GH}</a>
      </div>
    </header>
